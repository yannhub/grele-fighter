// grele-constants.js - Configuration spécifique au jeu Grêle Fighter
...
// Paramètres de l'interface (canvas)
export const UI = {
  gamePadding: 40,
  maxHeightRatio: 0.8,
  aspectRatio: 0.7,
...
export const GAME_CONFIG = {
  tagline: "Défendez vos cultures, sauvez la récolte!",
  description:
    "Prenez les commandes du canon anti-grêle et protégez les champs de maïs contre les intempéries destructrices!",
};
